...
resource "aws_s3_object" "ITSupportSpecialistResumeMarcellusBryan" {
  ...
  source = "/Users/marcellusbryan/.aws/TerraformConfigurations/ResumeProject/Resumewebsite/Website/ITSupportSpecialistResumeMarcellusBryan.html"
  content_type = "text/html"
  content_disposition = "inline"
  # The filemd5() function is available in Terraform 0.11.12 and later
  # For Terraform 0.11.11 and earlier, use the md5() function and the file() function:
  # etag = "${md5(file("path/to/file"))}"
  etag = filemd5("/Users/marcellusbryan/.aws/TerraformConfigurations/ResumeProject/Resumewebsite/Website/ITSupportSpecialistResumeMarcellusBryan.html")
}
resource "aws_s3_object" "styles" {
  bucket = aws_s3_bucket.subdomain.id
  key    = "styles.css"
  source = "/Users/marcellusbryan/.aws/TerraformConfigurations/ResumeProject/Resumewebsite/Website/styles.css"
  content_type = "text/css"

  # The filemd5() function is available in Terraform 0.11.12 and later
  # For Terraform 0.11.11 and earlier, use the md5() function and the file() function:
  # etag = "${md5(file("path/to/file"))}"
  etag = filemd5("/Users/marcellusbryan/.aws/TerraformConfigurations/ResumeProject/Resumewebsite/Website/styles.css")
}
resource "aws_s3_object" "NOTFOUND" {
  bucket = aws_s3_bucket.subdomain.id
  key    = "404NOTFOUND.txt"
  source = "/Users/marcellusbryan/.aws/TerraformConfigurations/ResumeProject/Resumewebsite/Website/404NOTFOUND.txt"
  content_type = "text/html"

  # The filemd5() function is available in Terraform 0.11.12 and later
  # For Terraform 0.11.11 and earlier, use the md5() function and the file() function:
  # etag = "${md5(file("path/to/file"))}"
  etag = filemd5("/Users/marcellusbryan/.aws/TerraformConfigurations/ResumeProject/Resumewebsite/Website/404NOTFOUND.txt")
}
